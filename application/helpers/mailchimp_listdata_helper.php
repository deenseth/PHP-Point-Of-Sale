...
function display_email_data(array $listMember, $list)
{
    ...
    if ($persontype !== 'Person') {
        ...
        $table_data_row.='<td width="50%" class="action">'
                       .anchor($controller_name."/view/$person->person_id/width:500", $CI->lang->line($controller_name.'_update'),array('class'=>'thickbox button pill left','title'=>$CI->lang->line($controller_name.'_update'), 'onClick'=>'tb_init(this);'))
