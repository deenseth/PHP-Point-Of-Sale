...
<?php echo form_label($this->lang->line('items_tax_1').':', 'tax_percent_1',array('class'=>'wide')); ?>
	...
	<?php echo form_input(array(
		...
		'id'=>'tax_name_1',
		'size'=>'10',
		'value'=> isset($item_tax_info[0]['name']) ? $item_tax_info[0]['name'] : $this->config->item('default_tax_1_name') ? $this->config->item('default_tax_1_name') : $this->lang->line('items_sales_tax_1'))
	);?>
	</div>
	<div class='form_field'>
	<?php echo form_input(array(
...
<?php echo form_label($this->lang->line('items_tax_2').':', 'tax_percent_2',array('class'=>'wide')); ?>
	...
	<?php echo form_input(array(
		...
		'id'=>'tax_name_2',
		'size'=>'10',
		'value'=> isset($item_tax_info[1]['name']) ? $item_tax_info[1]['name'] : $this->config->item('default_tax_1_name') ? $this->config->item('default_tax_2_name') : $this->lang->line('items_sales_tax_2'))
	);?>
	</div>
	<div class='form_field'>
	<?php echo form_input(array(
